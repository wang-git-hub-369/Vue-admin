	...
	<el-card class="box-card">
		...
		<el-form ref="form" :rules="rules" :model="form" label-width="120px">
			...
			<el-form-item label="商品货号">
				<el-input style="width: 220px;" v-model="form.articleNo"></el-input>
			...
			<el-form-item label="商品轮播图" prop="slider">
				<el-upload action="/api/upload/slider" :headers="headers" list-type="picture-card" :on-preview="handlePictureCardPreview" :on-success="sliderSuccess"
			...
			return {
				...
				rules: {
					...
					discount: [
						...
						{ type: 'number', min: 0, max: 9, message: '折扣在 0 到 9 之间', trigger: 'blur' }
					],
					inventory: [
					...
					// 	{ validator: /^(\-)*(\d+)\.(\d\d).*$/, message: '长度在 1 到 20 个字符', trigger: 'blur' }
					// ],
					img_md: [
